        ...
        <div class="card">
            ...
            <div class="card-body" style="border-radius: 8px">
                <div class="card mb-4 shadow-sm">
                    ...
                    <h4 style="margin:20px 30px 20px; color:black; font-size:25px;">Filter Data Masuk</h4>

                    <div class="card-body">
                        <form method="POST" action="{{ route('laporantransaksimasuk.post') }}">
                            @csrf
                            <div class="form-row">
                ...
                <div class="mt-5">
                    <p>Laporan Data Barang Masuk Dari Tanggal {{ $start_date }} - {{ $end_date }}</p>
                    @can('transaksi-masuk-cetak')
                        <div class="container d-flex justify-content-end">
                            <form method="POST" action="{{ route('printReportMasuk') }}">
                                @csrf
